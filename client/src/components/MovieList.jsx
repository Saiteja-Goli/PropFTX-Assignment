...
const MovieList = () => {
    ...
    const handleAddMovie = async (newMovie) => {
        try {
            const response = await axios.post("http://localhost:9000/movies/addmovie", newMovie);
    ...
    const handleEditMovie = async (editedMovie) => {
        try {
            const response = await axios.put(`http://localhost:9000/movies/edit/${editedMovie._id}`, editedMovie);
    ...
    const handleDeleteMovie = async (movieId) => {
        try {
            await axios.delete(`http://localhost:9000/movies/delete/${movieId}`);
